      ...
      <form action="" method="post" data-parsley-validate class="form form-horizontal form-label-left">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input name="NMPERSON" type="text"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Phone #1
            </label>
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input name="PHONE1" type="text"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Phone #2
            </label>
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input name="PHONE2" type="text"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
