          ...
          <table class="table table-striped jambo_table bulk_action">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    <a class="inline-edit" data-key="<?= $row['UID'] ?>" data-value="<?= $row['NM'] ?>" data-column="NM" href="#"><?= $row['NM'] ?></a>
                  </td>
                  <td><?= $row['DESCRIPTION'] ?></td>
                  <td>
                    <a class="inline-edit" data-key="<?= $row['UID'] ?>" data-value="<?= $row['VALUE'] ?>" data-column="VALUE" href="#"><?= $row['VALUE'] ?></a>
                  </td>
                  <td>
                    <div class="btn-group">
    ...
    <div class="modal-content">
      <form action="" method="post" data-parsley-validate class="form form-horizontal form-label-left">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Value
            </label>
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input name="VALUE" type="text"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
