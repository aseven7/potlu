            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td class="text-center">
                    <button name="set_default" value="<?= $row['UID'] ?>" type="submit" class="btn btn-xs <?= ($row['ISDEFAULT'] == 0) ? 'btn-default' : 'btn-primary' ?>"><span class="fa fa-check"></span></button>
                  </td>
                  <td>
                    <div class="btn-group">
      ...
      <form action="" method="post" data-parsley-validate class="form form-horizontal form-label-left">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Warehouse Name <span class="required">*</span>
            </label>
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input name="NM" type="text"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input name="CITY" type="text"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Locate
            </label>
            <div class="col-md-9 col-sm-9 col-xs-12">
            <textarea name="LOCATE" rows="5" class="form-control col-md-7 col-xs-12"></textarea> 
            </div>
          </div>
          <div class="form-group">
